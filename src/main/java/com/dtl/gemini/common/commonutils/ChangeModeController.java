package com.dtl.gemini.common.commonutils;
...
//                            Log.e("TAG", attrs.getAttributeName(i) + " , " + attrs.getAttributeValue(i));
    ...
    public static void setTheme(Context ctx,int Style_Day,int Style_Night){
        if(com.dtl.gemini.common.commonutils.ChangeModeHelper.getChangeMode(ctx) == com.dtl.gemini.common.commonutils.ChangeModeHelper.MODE_DAY){
            ctx.setTheme(Style_Day);
        }else if(com.dtl.gemini.common.commonutils.ChangeModeHelper.getChangeMode(ctx) == com.dtl.gemini.common.commonutils.ChangeModeHelper.MODE_NIGHT){
    ...
    public static void changeNight(Activity ctx,int style) {
        ...
        com.dtl.gemini.common.commonutils.ChangeModeHelper.setChangeMode(ctx, com.dtl.gemini.common.commonutils.ChangeModeHelper.MODE_NIGHT);
        ctx.setTheme(style);
        showAnimation(ctx);
        refreshUI(ctx);
    }
    ...
    public static void changeDay(Activity ctx,int style) {
        ...
        com.dtl.gemini.common.commonutils.ChangeModeHelper.setChangeMode(ctx, com.dtl.gemini.common.commonutils.ChangeModeHelper.MODE_DAY);
        ctx.setTheme(style);
        showAnimation(ctx);
        refreshUI(ctx);
    }
