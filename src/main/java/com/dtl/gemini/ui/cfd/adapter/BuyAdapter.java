...
public class BuyAdapter extends BaseAdapter {
    ...
    public BuyAdapter(Context context,List<CfdDepth> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.progress.setProgressDrawable(context.getResources().getDrawable(R.drawable.pro_cfd_green));
        viewHolder.progress.setMax((int) (max * mutil));
        CfdDepth bean = list.get(position);
        viewHolder.price.setTextColor(context.getResources().getColor(R.color.asset_green));
